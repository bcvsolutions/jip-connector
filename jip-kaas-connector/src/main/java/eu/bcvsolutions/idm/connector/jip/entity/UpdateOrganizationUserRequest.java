...
@XmlRootElement(name = "UpdateOrganizationUserRequest", namespace = "http://userportal.novell.com/ws/WS-LA-1.0")
public class UpdateOrganizationUserRequest {
    ...
    protected JAXBElement<UpdateOrganizationUserRequest.Address> address;
    @XmlElementRef(name = "email", namespace = "http://userportal.novell.com/ws/WS-LA-1.0", type = JAXBElement.class, required = false)
    protected JAXBElement<UpdateOrganizationUserRequest.Email> email;
    ...
    protected JAXBElement<UpdateOrganizationUserRequest.TelephoneNumber> telephoneNumber;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link UpdateOrganizationUserRequest.Address }{@code >}
     *     
     */
    public JAXBElement<UpdateOrganizationUserRequest.Address> getAddress() {
        return address;
    }
     ...
     *     
     */
    public void setAddress(JAXBElement<UpdateOrganizationUserRequest.Address> value) {
        this.address = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link UpdateOrganizationUserRequest.Email }{@code >}
     *     
     */
    public JAXBElement<UpdateOrganizationUserRequest.Email> getEmail() {
        return email;
    }
     ...
     *     
     */
    public void setEmail(JAXBElement<UpdateOrganizationUserRequest.Email> value) {
        this.email = value;
    }
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link UpdateOrganizationUserRequest.TelephoneNumber }{@code >}
     *     
     */
    public JAXBElement<UpdateOrganizationUserRequest.TelephoneNumber> getTelephoneNumber() {
     ...
     *     
     */
    public void setTelephoneNumber(JAXBElement<UpdateOrganizationUserRequest.TelephoneNumber> value) {
    ...
    public static class Email {
        ...
        @XmlElement(namespace = "http://userportal.novell.com/ws/WS-LA-1.0")
        protected List<UpdateOrganizationUserRequest.Email.Item> item;
         ...
         * {@link UpdateOrganizationUserRequest.Email.Item }
         * 
         * 
         */
        public List<UpdateOrganizationUserRequest.Email.Item> getItem() {
            if (item == null) {
                item = new ArrayList<UpdateOrganizationUserRequest.Email.Item>();
            }
            return this.item;
        }
    ...
    public static class TelephoneNumber {
        ...
        @XmlElement(namespace = "http://userportal.novell.com/ws/WS-LA-1.0")
        protected List<UpdateOrganizationUserRequest.TelephoneNumber.Item> item;
         ...
         * <p>
         * Objects of the following type(s) are allowed in the list
         * {@link UpdateOrganizationUserRequest.TelephoneNumber.Item }
         * 
         * 
         */
        public List<UpdateOrganizationUserRequest.TelephoneNumber.Item> getItem() {
            if (item == null) {
                item = new ArrayList<UpdateOrganizationUserRequest.TelephoneNumber.Item>();
            }
            return this.item;
        }
