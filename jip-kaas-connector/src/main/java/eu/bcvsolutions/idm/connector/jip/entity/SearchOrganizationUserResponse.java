...
@XmlRootElement(name = "SearchOrganizationUserResponse", namespace = "http://userportal.novell.com/ws/WS-LA-1.0")
public class SearchOrganizationUserResponse {

    @XmlElement(namespace = "http://userportal.novell.com/ws/WS-LA-1.0")
    protected List<SearchOrganizationUserResponse.Row> row;
     ...
     * {@link SearchOrganizationUserResponse.Row }
     * 
     * 
     */
    public List<SearchOrganizationUserResponse.Row> getRow() {
        if (row == null) {
            row = new ArrayList<SearchOrganizationUserResponse.Row>();
        }
        return this.row;
    }
    ...
    public static class Row {
        ...
        @XmlElement(namespace = "http://userportal.novell.com/ws/WS-LA-1.0")
        protected SearchOrganizationUserResponse.Row.Address address;
        @XmlElement(namespace = "http://userportal.novell.com/ws/WS-LA-1.0")
        protected SearchOrganizationUserResponse.Row.Email email;
        @XmlElement(namespace = "http://userportal.novell.com/ws/WS-LA-1.0")
        protected SearchOrganizationUserResponse.Row.TelephoneNumber telephoneNumber;
        @XmlElement(namespace = "http://userportal.novell.com/ws/WS-LA-1.0")
         ...
         * @return
         *     possible object is
         *     {@link SearchOrganizationUserResponse.Row.Address }
         *     
         */
        public SearchOrganizationUserResponse.Row.Address getAddress() {
            return address;
        }
         ...
         *     
         */
        public void setAddress(SearchOrganizationUserResponse.Row.Address value) {
            this.address = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link SearchOrganizationUserResponse.Row.Email }
         *     
         */
        public SearchOrganizationUserResponse.Row.Email getEmail() {
            return email;
        }
         ...
         *     
         */
        public void setEmail(SearchOrganizationUserResponse.Row.Email value) {
            this.email = value;
        }
         ...
         * @return
         *     possible object is
         *     {@link SearchOrganizationUserResponse.Row.TelephoneNumber }
         *     
         */
        public SearchOrganizationUserResponse.Row.TelephoneNumber getTelephoneNumber() {
         ...
         *     
         */
        public void setTelephoneNumber(SearchOrganizationUserResponse.Row.TelephoneNumber value) {
        ...
        public static class Email {
            ...
            @XmlElement(namespace = "http://userportal.novell.com/ws/WS-LA-1.0")
            protected List<SearchOrganizationUserResponse.Row.Email.Item> item;
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link SearchOrganizationUserResponse.Row.Email.Item }
             * 
             * 
             */
            public List<SearchOrganizationUserResponse.Row.Email.Item> getItem() {
                if (item == null) {
                    item = new ArrayList<SearchOrganizationUserResponse.Row.Email.Item>();
                }
                return this.item;
            }
            ...
            public static class Item {
                ...
                protected SearchOrganizationUserResponse.Row.Email.Item.Type type;
                @XmlElement(namespace = "http://userportal.novell.com/ws/WS-LA-1.0", required = true)
                 ...
                 * @return
                 *     possible object is
                 *     {@link SearchOrganizationUserResponse.Row.Email.Item.Type }
                 *     
                 */
                public SearchOrganizationUserResponse.Row.Email.Item.Type getType() {
                    return type;
                }
                 ...
                 *     
                 */
                public void setType(SearchOrganizationUserResponse.Row.Email.Item.Type value) {
                    this.type = value;
                }
        ...
        public static class TelephoneNumber {
            ...
            @XmlElement(namespace = "http://userportal.novell.com/ws/WS-LA-1.0")
            protected List<SearchOrganizationUserResponse.Row.TelephoneNumber.Item> item;
             ...
             * <p>
             * Objects of the following type(s) are allowed in the list
             * {@link SearchOrganizationUserResponse.Row.TelephoneNumber.Item }
             * 
             * 
             */
            public List<SearchOrganizationUserResponse.Row.TelephoneNumber.Item> getItem() {
                if (item == null) {
                    item = new ArrayList<SearchOrganizationUserResponse.Row.TelephoneNumber.Item>();
                }
                return this.item;
            }
            ...
            public static class Item {
                ...
                @XmlElement(namespace = "http://userportal.novell.com/ws/WS-LA-1.0", required = true)
                protected SearchOrganizationUserResponse.Row.TelephoneNumber.Item.Type type;
                @XmlElement(namespace = "http://userportal.novell.com/ws/WS-LA-1.0", required = true)
                 ...
                 * @return
                 *     possible object is
                 *     {@link SearchOrganizationUserResponse.Row.TelephoneNumber.Item.Type }
                 *     
                 */
                public SearchOrganizationUserResponse.Row.TelephoneNumber.Item.Type getType() {
                    return type;
                }
                 ...
                 *     
                 */
                public void setType(SearchOrganizationUserResponse.Row.TelephoneNumber.Item.Type value) {
                    this.type = value;
                }
